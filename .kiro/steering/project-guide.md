...
## 운영 가이드 (gstack 컨셉 커스텀)

- #[[file:.gemini/skills/ops-review/SKILL.md]] — 코드 리뷰 체크리스트
- #[[file:.gemini/skills/ops-qa/SKILL.md]] — QA 테스트 체크리스트
- #[[file:.gemini/skills/ops-plan/SKILL.md]] — 기획 리뷰 (CEO Mode)
